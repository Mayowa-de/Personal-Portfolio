...
export default function About() {
  const stats = [[BriefcaseBusiness, '3+', 'Years experience'], [Package, '28+', 'Projects completed'], [ShieldCheck, '15+', 'Happy clients'], [Atom, '1M+', 'Users impacted']] as const
    ...
    <Reveal className="content-section" id="about">
      ...
      <div className="about-grid">
        ...
        <div className="about-copy">
          <p>I am a Frontend Engineer who creates performant, user-friendly applications. I care about clean code, intuitive design, and solutions that make a measurable difference.</p>
        ...
        <div>
          <div className="code-card">const <span className="value">developer</span> = {'{'}<br /><span>&nbsp;&nbsp;name: <span className="value">'Mayowa Ojomu'</span>,</span><br /><span>&nbsp;&nbsp;role: <span className="value">'Frontend Engineer'</span>,</span><br /><span>&nbsp;&nbsp;skills: <span className="value">['React', 'TypeScript', 'Node.js']</span>,</span><br /><span>&nbsp;&nbsp;passion: <span className="value">'Building products that matter'</span></span><br />{'}'}</div>
